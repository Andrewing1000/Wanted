<template>
    <nav>
      ...
      <div class="auth-buttons">
        <router-link to="/register"><button class="register-btn">Registrarse</button></router-link>
        <router-link to="/login"><button class="login-btn">Iniciar Sesión</button></router-link>
      </div>
    </nav>
  </template>
